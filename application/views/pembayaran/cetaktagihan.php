...
<body>
    ...
    <h6 class="text-center">Nama <?= $siswa['nama'] ?></h6>
    <h6 class="text-center">Nis <?= $siswa['nis'] ?></h6>
    <h6 class="text-center">Tahun Ajaran <?= $thn_ajrn; ?></h6>
    <h6 class="text-center">Semester <?= $smster ?></h6>
    ...
    <table class="width:100%">
        ...
        <?php
        $this->db->where('tahun_ajaran', $thn_ajrn);
        $this->db->where('id_semester', $smster);
